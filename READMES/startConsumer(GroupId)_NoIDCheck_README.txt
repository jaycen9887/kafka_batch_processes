...
# THIS BATCH PROCESS IS TO START A KAFKA CONSUMER.
...
# YOU WILL BE PROMPTED TO ENTER A GROUPID.
	## NOTE THAT IF THE GROUPID DOESN'T EXISTS ALREADY, IT WILL CREATE THE GROUP

	## IT WILL CHECK IF THE TOPIC IS A VALID TOPIC, USER IS GIVEN 3 TRIES BEFORE PROGRAM WILL EXIT 
		### IF IT IS A VAILD TOPIC NAME, IT WILL RUN THE COMMAND TO START THE CONSUMER 
			#### IF THE GROUPID HAS PREVIOUSLY CONSUMED ALL UN-CONSUMED OFFSETS, THERE WILL BE BLANK SPACE UNDER THE COMMANDS AND WILL AWAIT FOR NEW RECORDS. 
