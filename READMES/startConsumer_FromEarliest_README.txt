...
# THIS BATCH PROCESS IS TO START A KAFKA CONSUMER FROM THE FIRST OFFSET.
...
# YOU WILL BE PROMPTED TO ENTER A TOPIC NAME.
	## IF IT IS A VAILD TOPIC NAME, A CONSUMER WILL BE STARTED FROM THE LATEST OFFSET (WILL ONLY CONSUME NEW RECORDS.
		### ONCE STARTED THE SCREEN WILL PRINT OUT ALL THE RECORDS FROM THE FIRST OFFSET IN EACH PARTITION, IF THERE ARE ANY. IF THERE AREN'T ANY RECORDS TO CONSUME, IT WILL ONLY DISPLAY A BLANK LINE, AWAITING FOR RECORDS TO BE SENT TO TOPIC
